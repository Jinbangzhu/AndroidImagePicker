...
#include "com_cndroid_imagepicker_JniBitmapHolder.h"
...
Java_com_cndroid_imagepicker_JniBitmapHolder_jniCropBitmap(
        JNIEnv
        *env,
        jobject obj, jobject
        handle,
        uint32_t left, uint32_t
        top,
        uint32_t right, uint32_t
        bottom) {
    ...
    for (
            ...
            y < bottom;
            ++y) {
        memcpy(whereToPut, whereToGet,
               sizeof(uint32_t) * newWidth);
        whereToGet +=
                oldWidth;
        whereToPut +=
                newWidth;
...
//done copying , so replace old data with new one
    delete[]
            previousData;
    jniBitmap->
            _storedBitmapPixels = newBitmapPixels;
    jniBitmap->_bitmapInfo.
            width = newWidth;
    jniBitmap->_bitmapInfo.
            height = newHeight;
}
...
JNIEXPORT void JNICALL
Java_com_cndroid_imagepicker_JniBitmapHolder_jniRotateBitmapCcw90(
        JNIEnv
        *env,
        jobject obj, jobject
        handle) {
...
JNIEXPORT void JNICALL
Java_com_cndroid_imagepicker_JniBitmapHolder_jniRotateBitmapCw90(
        JNIEnv
        *env,
        jobject obj, jobject
        handle) {
...
JNIEXPORT void JNICALL
Java_com_cndroid_imagepicker_JniBitmapHolder_jniRotateBitmap180(
        JNIEnv
        *env,
        jobject obj, jobject
        handle) {
...
/**free bitmap*/ //
JNIEXPORT void JNICALL
Java_com_cndroid_imagepicker_JniBitmapHolder_jniFreeBitmapData(
        JNIEnv
        *env,
        jobject obj, jobject
        handle) {
...
JNICALL Java_com_cndroid_imagepicker_JniBitmapHolder_jniGetBitmapFromStoredBitmapData(
...
JNICALL Java_com_cndroid_imagepicker_JniBitmapHolder_jniStoreBitmapData(
...
JNIEXPORT void JNICALL
Java_com_cndroid_imagepicker_JniBitmapHolder_jniScaleNNBitmap(
        JNIEnv
        *env,
        jobject obj, jobject
        handle,
    ...
    for (
        ...
        for (
            ...
            if (y2 < 0)
                ...
                y2 = oldHeight - 1;
            newBitmapPixels[whereToPut++] = previousData[(
                                                                 y2 * oldWidth
                                                         ) + x2];
 ...
 * */ //
JNIEXPORT void JNICALL
Java_com_cndroid_imagepicker_JniBitmapHolder_jniScaleBIBitmap(
        JNIEnv
        *env,
        jobject obj, jobject
        handle,
...
//rgbBottomRight=startingImageData[xTopLeft+1][yTopLeft+1];
                ...
                rgbBottomMiddle.
                        alpha = rgbBottomLeft.alpha * xcRatio2
                                + rgbBottomRight.alpha * xcratio1;
                rgbBottomMiddle.
                        red = rgbBottomLeft.red * xcRatio2
                              + rgbBottomRight.red * xcratio1;
                rgbBottomMiddle.
                        green = rgbBottomLeft.green * xcRatio2
                                + rgbBottomRight.green * xcratio1;
                rgbBottomMiddle.
                        blue = rgbBottomLeft.blue * xcRatio2
...
//rgbTopRight=startingImageData[xTopLeft+1][yTopLeft];
                ...
                rgbTopMiddle.
                        alpha = rgbTopLeft.alpha * xcRatio2
                                + rgbTopRight.alpha * xcratio1;
                rgbTopMiddle.
                        red = rgbTopLeft.red * xcRatio2
                              + rgbTopRight.red * xcratio1;
                rgbTopMiddle.
                        green = rgbTopLeft.green * xcRatio2
                                + rgbTopRight.green * xcratio1;
                rgbTopMiddle.
                        blue = rgbTopLeft.blue * xcRatio2
...
// prepared all pixels to look at, so finally set the new pixel data
            result.
                    alpha = rgbTopMiddle.alpha * ycRatio2
                            + rgbBottomMiddle.alpha * ycRatio1;
            result.
                    blue = rgbTopMiddle.blue * ycRatio2
                           + rgbBottomMiddle.blue * ycRatio1;
            result.
                    red = rgbTopMiddle.red * ycRatio2
                          + rgbBottomMiddle.red * ycRatio1;
            result.
                    green = rgbTopMiddle.green * ycRatio2
                            + rgbBottomMiddle.green * ycRatio1;
            newBitmapPixels[(
                                    y * newWidth
                            ) + x] =
                    convertArgbToInt(result);
        }
    }
 ...
 * */ //
JNIEXPORT void JNICALL
Java_com_cndroid_imagepicker_JniBitmapHolder_jniFlipBitmapHorizontal(
        JNIEnv
        *env,
        jobject obj, jobject
        handle) {
 ...
 * */ //
JNIEXPORT void JNICALL
Java_com_cndroid_imagepicker_JniBitmapHolder_jniFlipBitmapVertical(
        JNIEnv
        *env,
        jobject obj, jobject
        handle) {
